...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
                ...
                case .singleColor:
                    SingleColorView(color: nightLight.singleLightColor.color)
                        .ignoresSafeArea()
                case .colorChange:
                    SingleColorView(color: colorTimer.activeColor.color)
                            .ignoresSafeArea()
                            .onDisappear() {
